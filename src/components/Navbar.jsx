...
const Navbar = () => {
  ...
  let scrollActive = scroll ? "py-6 bg-gray-700 shadow" : "py-4"
    ...
    <div className={`navbar fixed w-full transition-all ${scrollActive}`}>
      <div className="container mx-auto px-4">
        <div className="navbar-box flex items-center justify-between">
          ...
          md:translate-y-0 md:text-black md:p-0 md:m-0 md:transition-none gap-8 fixed ${menuActive} top-1/2 -translate-y-1/2 
          flex-col px-8 py-6 rounded shadow-lg shadow-black bg-amber-700 font-bold text-black transition-all`}>
          ...
          <div className="social flex items-center gap-2">
            <a href="#social" className="bg-amber-700 px-5 py-2 rounded-full text-black font-bold hover:bg-amber-800 transition-all">
              Social Media
            </a>
